                          ...
                          child: Row(
                            children: [
                              SizedBox(
                                  width: 120.0,
                                  child: Image.asset(
                                    'assets/stores/${activities[index]['img_path']}',
                                    height: 120.0, fit: BoxFit.fitHeight,)),
                              SizedBox(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment
                                        .start,
                                    children: [
                                      Text(activities[index]['storeName'],
                                        style: TextStyle(
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Icon(Icons.star, color: Colors.red,
                                            size: 10.0,),
                                          Text(
                                            '${activities[index]['score']}(${activities[index]['reviewNum']})',
                                            style: TextStyle(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 18.0),),
                                        ],
                                          ...
                                          child: InkWell(
                                              onTap: () {
                                                ...
                                                StoreModel store = StoreModel
                                                    .fromMap({
                                                  'storeKey': 'sov15ng4vh1wan199vs9Shv0w9',
                                                  'ownerKey': '123456789',
                                                  'profileImgs': [],
                                                  'field': '서핑',
                                                  'storeName': '서귀포 서핑샵',
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Center(child: Text('MY 액티비티',
          ...
          TextButton(
            ...
            child: Text(setOption ? '완료' : '편집', style: const TextStyle(
