...
class _MyActivityScreenState extends State<MyActivityScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: widget.user.isBusiness?_isBusiness():_isNotBusiness(),
    );
  }
        ...
        child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text('비즈니스 계정이 아닙니다.\n지금 등록하시겠습니까?', textAlign: TextAlign.center,),
                ),
                TextButton(
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => BusinessTransferPage(user: widget.user)));
                  },
                  child: Text('비즈니스 계정\n전환하기', textAlign: TextAlign.center,),
  ...
  Widget _isBusiness() {
    return Scaffold(
      body: Column(
        children: [_topBar(), _listActivity()],
      ),
      floatingActionButton: setOption
